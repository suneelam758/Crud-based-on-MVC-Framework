...
<body>
  <!--------------------------------------Admin data -------------------------------------------------------->
   <b>
    ...
    <h1><tt style="padding: 10px;">Welcome <span style="user-select: none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <button class="btn btn-outline-primary"><a href="">LogOut</a></button></h1></tt>
  ...
  <tbody>
    <tr>
      <th scope="row"><Select name="i4" id="i4">
        
       
       
    </Select></th>

      <td><Select name="i5" id="i5">
        
       </td>

      <td><input type="number" placeholder="Expected Guest" name="i6" min="1" oninput="validity.valid||(value='');"></td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <th scope="row"><input type="date" name="i7" id="i7" required></th>
      
      <td><input type="date" name="i8" id="i8" onchange="dat()" required> <br><span id="sp"></span></td>
      <td><input type="number" placeholder="total days" id="i9"  name="i9" required readonly></td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      ...
      <td><input type="text" placeholder="total time" name="i12" id="i12"></td>
    </tr>
  </tbody>
 ...
 $(document).ready(function()
 {
	$("#insertform").submit(function() {
	 ...
	 var data1 = $("#insertform").serialize();
				$.ajax({
					type: 'POST',
					url: 'http://localhost/mvc_asses/insert/read1',
					data: data1,
          dataType: 'json',
